  ...
  return (
    <div className="min-h-screen bg-background text-white flex flex-col">
      <header className="p-4 flex items-center justify-center">
        <div className="flex items-center gap-2">
          <img 
            ...
            className="h-8 w-8"
          />
          <h1 className="text-2xl font-bold">NextWorkout.io</h1>
        </div>
      </header>
        ...
        <div className="max-w-md w-full text-center space-y-12">
          ...
          <div className="grid grid-cols-1 gap-6 pt-4">
            <div className="flex flex-col items-center">
              ...
              <p className="text-zinc-400 text-sm">Organize your exercises into customizable groups</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-zinc-400 text-sm">Focus on exercises you haven't done in a while</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-zinc-400 text-sm">View your workout history and progress over time</p>
            </div>
          </div>
      ...
      <footer className="p-4 text-center text-zinc-500 text-xs">
        <p>NextWorkout.io - Find your optimal next workout</p>
      </footer>
    </div>
  );
};
